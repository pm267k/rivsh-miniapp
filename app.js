...
function картаЗадания(з, прошлое, сПредметом, полная){
  ...
  c.appendChild(эл('div','задание',
    (сПредметом?'<div class="предмет">'+экр(имяКапса(з.дис)||'без предмета')+'</div>':'')+
    '<div class="строка"><div class="что">'+экр(з.что)+'</div>'+
    '<span class="срок'+(прошлое?'':з.кл)+'">'+экр(подписьДаты(з.срок))+'</span>'+
    (есть?'<div class="ведёт вниз">›</div>':'')+'</div>'+
